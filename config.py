...
RE_TICKET = r'\b[0-9А-ЯA-Zа-яa-z]{2,4}-\d{10}\b'
RE_RAIL_TICKET = r'\b(?:[А-ЯA-Zа-яa-z]{3}-)?\d{14}\b'
RE_ORDER = r'\b(?:Заказ|заказ|заказа|№)?\s*(\d{7,10})\b'

# Ключевые слова для классификации услуг
SERVICE_CLASSIFICATION = {
    "Hotel": ["проживание", "отель", "г-ца", "гостиница", "размещение"],
    "Seat": ["выбор места", "место", "mco"],
    "Fee": ["услуга ито", "сервисный сбор", "ито", "сбор"],
    "Penalty": ["штраф", "удержания", "удержание"],
    "Flight": ["авиабилет", "билет", "возврат авиабилета", "перелет", "авиа", "ж.д.", "поезд"]
}
...
COL_MAP_SINGLE_BT = {"date": 8, "doc": 9, "debit": 10, "credit": 11, "profit": 12, "net": 13}

# Раздельные файлы
COL_MAP_DOUBLE_TP = {"date": 1, "doc": 2, "debit": 3, "credit": 4}
COL_MAP_DOUBLE_BT = {"date": 1, "doc": 2, "debit": 3, "credit": 4, "profit": 5, "net": 6}
